export const experiences = [
  ...
  {
    company: "ICFX Technologies",
    role: "Cell Phone Technician",
    location: "Ellicott City, MD",
    duration: "October 2017 - September 2020",
    bullets: [
      "Installed and repaired cell phone/computer hardware, software, and peripheral equipment according to design or installation specifications.",
      "Developed training procedures and instructed users in proper hardware and software usage.",
      "Answered customer inquiries regarding cell phone software and hardware operations.",
    ],
    expanded: false
  },
  {
